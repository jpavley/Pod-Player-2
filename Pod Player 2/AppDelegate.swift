...
//  Pod Player 2
//
//  Created by John Pavley on 12/13/16.
...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "Pod_Player_2", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        if failError == nil {
            ...
            let url = self.applicationDocumentsDirectory.appendingPathComponent("Pod_Player_2.storedata")
            do {
